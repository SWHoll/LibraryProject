...
<html>
    ...
    <body>
        ...
        <div class="section-heading">ADD A NEW BOOK TO THE LIBRARY</div>
        <div class="add_book_form">
            <form method="post" action="/add_book/added">
                TITLE: <input type="text" name="title"><br>
                AUTHOR: <input type="text" name="author"><br>
                GENRE: <input type="text" name="genre"><br>
                DESCRIPTION: <br><textarea cols=111 rows=5 name="description"></textarea><br>
                LOCATION: <input type="text" name="location"><br>
                DATE ADDED (dd/mm/yyyy): <input type="text" name="date"><br>
                COVER ID: <input type="text" name="cover"><br>
                BARCODE NUMBER:<br>For multiple copies separate with whitespace.<input type="text" name="barcode_nums"><br>
