...
<html>
    <head>
	<meta charset="utf8">
	<title>My Loans | MyLibrary</title>
    ...
    <body>
        ...
        <div class="info" style="padding-top:12px">
            ...
            <loan-time style="float:left; padding-left:12px">DUE BACK IN 5 DAYS</loan-time><br/><br/><br/>
        ...
        <div class="info" style="padding-top:12px">
            ...
            <loan-time style="float:left; padding-left:12px">DUE BACK IN 3 DAYS</loan-time><br/><br/><br/>
            <button class="button" style="margin-left:24px">RENEW THIS LOAN</button>
        </div>
